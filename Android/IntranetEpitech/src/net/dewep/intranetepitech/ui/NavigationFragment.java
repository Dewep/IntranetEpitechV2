...
import net.dewep.intranetepitech.ui.widget.EpitechProfilPicture;
...
public class NavigationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        EpitechProfilPicture personalPicture = (EpitechProfilPicture) rootView.findViewById(R.id.ui_navigation_personal_picture);
        personalPicture.execute(EpitechAccount.getLogin());
