 ...
 */
package net.dewep.intranetepitech.ui.about;
...
public class AboutFragment extends UiFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup rootView = (ViewGroup) inflater.inflate(R.layout.ui_about_fragment, container, false);
        return rootView;
    }

    @Override
    protected int getIdTitle() {
        return R.string.navigation_about;
    }
